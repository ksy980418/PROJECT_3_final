...
public class ClothesAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clothes.setImageBitmap(FragmentTwo.cur_image);
        ...
        add_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    jsonObject.put("image", bitmap2ByteArray(FragmentTwo.cur_image));
                    jsonObject.put("group1", group1.getSelectedItem().toString());
                    jsonObject.put("group2", group2.getSelectedItem().toString());
                    jsonArray.put(jsonObject);
                } catch (JSONException e) {
                    e.printStackTrace();
                }
                new JSONTask(jsonArray).execute("add_cloth");
            }
        });
    }
